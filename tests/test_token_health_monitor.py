...
class TokenHealthMonitorTests(unittest.TestCase):
    def test_returns_success_when_all_tokens_are_above_threshold(self):
        ...
        self.assertIn("im: ok", stdout.getvalue())
        self.assertNotIn("TOKEN", stdout.getvalue())

    def test_warns_when_active_instamart_token_is_below_threshold(self):
        payload = {
            "swiggy_tokens": {
                "food": {"logged_in": True, "expired": False, "expires_in_s": 90_000},
                "im": {"logged_in": True, "expired": False, "expires_in_s": 3_600},
                "dineout": {"logged_in": True, "expired": False, "expires_in_s": 90_000},
            }
        }
        ...
        self.assertIn("im: expiring_soon", stdout.getvalue())

    def test_fails_when_active_instamart_token_is_expired_or_missing(self):
        payload = {
            "swiggy_tokens": {
                "food": {"logged_in": True, "expired": False, "expires_in_s": 90_000},
    ...
    def test_explicit_keys_can_still_check_all_swiggy_tokens(self):
        payload = {
            "swiggy_tokens": {
        ...
        stdout = io.StringIO()
        with redirect_stdout(stdout):
            exit_code = check_swiggy_token_health.evaluate_health(
                payload,
                warn_seconds=86_400,
